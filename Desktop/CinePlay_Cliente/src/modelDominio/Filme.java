...
public class Filme implements Serializable {
    ...
    public Filme(int idFilme, int idCinema, String numeroPoltronas, String titulo, String descricao, String classificacao, float preco, String dataInicio, String dataTermino) {
    ...
    public Filme(int idCinema, String titulo, String descricao, String classificacao, String numeroPoltronas, float preco, String dataInicio, String dataTermino) {
        this.idCinema = idCinema;
        this.titulo = titulo;
        this.descricao = descricao;
        this.classificacao = classificacao;
