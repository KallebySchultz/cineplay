...
public class Filme implements Serializable {
    ...
    public Filme(int idFilme, int idCinema, String titulo, String descricao, String classificacao, String numeroPoltronas, float preco, String dataInicio, String dataTermino) {
    ...
    public Filme(String titulo, String descricao, String classificacao, String numeroPoltronas, float preco, String dataInicio, String dataTermino) {
        this.titulo = titulo;
        this.descricao = descricao;
        this.classificacao = classificacao;
        this.numeroPoltronas = numeroPoltronas;
